...
class PgsqlQueryBuilderTest extends BaseTestCase
{
    ...
    public function it_should_returns_the_correct_multiple_insert_query()
    {
        ...
        foreach ($queries as $query) {
            $expectedQuery = 'INSERT INTO example_table (id, name, username) VALUES (:id_utente_1, :name_utente_1, :username_utente_1), (:id_utente_2, :name_utente_2, :username_utente_2), (:id_utente_3, :name_utente_3, :username_utente_3) ON CONFLICT DO NOTHING';
    ...
    public function it_should_returns_the_correct_single_insert_query()
    {
        ...
        foreach ($queries as $query) {
            $expectedQuery = 'INSERT INTO example_table (id, name, username) VALUES (:id_utente, :name_utente, :username_utente) ON CONFLICT DO NOTHING';
    ...
    public function it_should_returns_the_correct_clear_data_query()
    {
        ...
        $this->assertEquals('TRUNCATE TABLE example_table', $expectedQuery);
    }
